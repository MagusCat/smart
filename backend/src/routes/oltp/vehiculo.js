...
router.get('/', async (req, res) => {
  try {
    ...
    const result = await pool.request()
      ...
      .query(`
        SELECT id_vehiculo, num_chasis, num_motor, modelo, Marca.marca, Categoria.categoria, Tipo_vehiculo.vehiculo
        FROM Vehiculo
        LEFT JOIN Marca on Marca.id_marca = Vehiculo.id_marca
        LEFT JOIN Categoria on Categoria.id_categoria = Vehiculo.id_categoria
        LEFT JOIN Tipo_vehiculo on Tipo_vehiculo.id_tipo_vehiculo = Vehiculo.id_tipo_vehiculo
