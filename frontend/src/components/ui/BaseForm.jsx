// frontend/src/components/ui/BaseForm.jsx
import React, { useState, useEffect, useRef } from 'react';

const BaseForm = ({ title, children, onAccept, onCancel, isVisible, extra }) => {
    ...
    const handleOverlayClick = (event) => {
        if (formRef.current && !formRef.current.contains(event.target) && onCancel) {
            onCancel();
        }
    };
