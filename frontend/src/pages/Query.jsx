...
function Query() {
  ...
  return (
    <div className="flex flex-row w-full h-140">
      <aside
      ...
      <Card className="w-full h-full mx-auto p-6 flex flex-col gap-6 rounded-xl shadow-xl border-gray-400 border-2 bg-white text-black">
